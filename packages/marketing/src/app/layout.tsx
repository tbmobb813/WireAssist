...
export const metadata: Metadata = {
  title: 'WireAssist — Run a Business. Solo.',
  description:
    'Build an AI workforce that manages your admin and amplifies your ideas. A TechTrendWire product.',
  openGraph: {
    title: 'WireAssist — Run a Business. Solo.',
    description: 'AI tools for solo operators. Your workforce, your rules.',
    type: 'website',
    url: 'https://wireassist.techtrendwire.com',
  },
  twitter: {
