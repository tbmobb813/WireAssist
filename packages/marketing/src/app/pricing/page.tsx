  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-5xl mx-auto px-6 py-20">
        <div className="text-xs tracking-widest mb-4 text-center" style={{ color: '#4fc3f7' }}>
          PRICING
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {TIERS.map((tier) => (
            ...
            >
              ...
              {LAUNCH_MODE === 'live' ? (
                <a
                  href={process.env[`NEXT_PUBLIC_LS_URL_${tier.id.toUpperCase()}`] ?? '#'}
        ...
        >
          <p className="text-xs text-gray-500 leading-relaxed">
            All plans include a 14-day free trial. No credit card required. Payments processed by
            LemonSqueezy. Cancel anytime from your account dashboard.
          </p>
        </div>
      </div>
