...
const PLATFORMS = [
  ...
  { name: 'Linux', icon: '🐧', arch: 'x64', ext: '.AppImage', note: 'Ubuntu, Fedora, Arch' },
  {
    ...
    arch: 'arm64',
    ext: '.AppImage',
    note: 'Raspberry Pi 4/5, ARM servers',
  },
];
    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-gray-400 text-sm leading-relaxed mb-12 max-w-xl">
          SynqAgent runs entirely on your machine. Your data never leaves your device. Download,
          install, add your Anthropic API key, and your workforce is ready in minutes.
        </p>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-sm font-bold">
                    {p.name} <span className="text-gray-500 font-normal">({p.arch})</span>
                  </div>
        ...
        <div
          ...
          style={{ background: '#0d0d1a', border: '1px solid #1e2040' }}
        >
          <div className="text-xs tracking-widest mb-4" style={{ color: '#ffb347' }}>
            SETUP IN 3 STEPS
          </div>
          {[
            ...
            {
              n: '2',
              text: 'Open Settings → enter your Anthropic API key. Get one at console.anthropic.com.',
            },
            {
              n: '3',
              text: 'Enter your license key (from your LemonSqueezy purchase email) and click Activate.',
            },
          ].map((s) => (
            <div key={s.n} className="flex items-start gap-4 mb-4 last:mb-0">
              <div className="text-lg font-black flex-shrink-0" style={{ color: '#ffb347' }}>
                {s.n}
              </div>
        ...
        <p className="text-xs text-gray-600 leading-relaxed">
          macOS builds are coming soon (requires Apple Developer signing). In the meantime, macOS
          users can{' '}
          <a
            href="https://tauri.app/distribute/building/"
