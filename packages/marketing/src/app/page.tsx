...
const PROBLEMS = [
  {
    pain: 'Inbox anxiety eating your mornings',
    fix: 'Admin Agent triages it. You get a clean summary with proposed replies — approve in one click.',
  },
  {
    pain: 'Calendar chaos and back-to-back meetings',
    fix: 'Calendar Agent spots conflicts before they happen and handles scheduling on your behalf.',
  },
  {
    pain: 'Content that never gets written',
    fix: 'Content Agent generates a week of posts in one shot. You approve the ones you like.',
  },
  {
    pain: 'Tools that make decisions for you',
    fix: 'Every action requires your explicit approval. You are always the decision-maker.',
  },
];
...
const HOW_IT_WORKS = [
  {
    step: '01',
    color: '#4fc3f7',
    title: 'Tell your agents about your business',
    body: 'A 10-question onboarding fills the shared memory store. Your agents know your clients, your tone, your priorities before they run their first task.',
  },
  {
    step: '02',
    color: '#00ff9d',
    title: 'Agents work in the background',
    body: 'Your Admin Agent triages your inbox every morning. Your Content Agent prepares a weekly post plan. All without you lifting a finger.',
  },
  {
    step: '03',
    color: '#ffb347',
    title: 'You approve. They execute.',
    body: 'Every proposed action lands in your Approval Queue. Tap Approve or Reject. Nothing happens without your sign-off.',
  },
  {
    step: '04',
    color: '#c084fc',
    title: 'The system gets smarter',
    body: 'Every approval and rejection is stored in shared memory. Agents learn your preferences over time. The longer you use it, the better it gets.',
  },
];
...
const AGENTS = [
  {
    ...
    color: '#4fc3f7',
    capabilities: [
      'Triages unread emails every morning',
      'Drafts replies for your approval',
      'Spots calendar conflicts before they happen',
      'Schedules meetings on your behalf',
      'Flags urgent items immediately',
    ],
    tier: 'solo',
  },
  {
    ...
    color: '#ffb347',
    capabilities: [
      'Generates posts for any platform',
      'Builds weekly content plans',
      'Scores post quality before presenting',
  ...
  },
  {
    ...
    color: '#c084fc',
    capabilities: [
      'Deep-dives any topic on demand',
      'Synthesizes findings into memory',
      'Surfaces relevant context for decisions',
      'Monitors topics you care about',
      'Available on Workforce plan',
    ],
    tier: 'workforce',
  },
];
    ...
    <div className="min-h-screen">
      ...
      <nav
        ...
        style={{
          ...
          borderBottom: '1px solid #1e204050',
        }}
      >
        <div className="text-sm font-black tracking-widest">WIREASSIST</div>
        <div className="flex items-center gap-6">
          <a
            href="#how-it-works"
            className="text-xs text-gray-500 hover:text-white transition-colors tracking-widest hidden md:block"
          >
            HOW IT WORKS
          </a>
          <a
          ...
          <Link
            href="/download"
            className="text-xs px-4 py-2 rounded tracking-widest transition-colors"
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div
            className="orb absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full"
            style={{ background: 'radial-gradient(circle, #ffb34720 0%, transparent 70%)' }}
          />
          <div
            className="orb-delay absolute bottom-1/4 left-1/4 w-72 h-72 rounded-full"
            style={{ background: 'radial-gradient(circle, #4fc3f715 0%, transparent 70%)' }}
          />
          <div
            className="orb-delay absolute bottom-1/4 right-1/4 w-72 h-72 rounded-full"
        ...
        <div className="relative text-center px-6 max-w-4xl mx-auto">
          ...
          <h1
            ...
            style={{ fontSize: 'clamp(48px, 10vw, 96px)', letterSpacing: '-2px' }}
          >
            RUN A BUSINESS.
            <br />
            SOLO.
          ...
          <p
            className="text-gray-400 mb-10 mx-auto max-w-xl leading-relaxed"
            style={{ fontSize: 'clamp(14px, 2vw, 18px)' }}
          >
            Build an AI workforce that manages your admin and amplifies your ideas. You stay in
            control. Agents handle the overhead.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {LAUNCH_MODE === 'live' ? (
              <Link
                href="/pricing"
                className="px-8 py-4 rounded-lg text-sm font-black tracking-widest"
            ...
            <a
              href="#how-it-works"
              className="px-8 py-4 rounded-lg text-sm font-bold tracking-widest transition-colors"
      ...
      <section className="py-24 px-6" style={{ borderTop: '1px solid #1e2040' }}>
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-3xl font-black text-center mb-16">
            Solo operators drown in overhead.
          </h2>
      ...
      <section id="how-it-works" className="py-24 px-6" style={{ borderTop: '1px solid #1e2040' }}>
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-3xl font-black text-center mb-16">
            Your AI workforce, on your terms.
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {HOW_IT_WORKS.map((s) => (
              ...
              >
                <div className="text-3xl font-black mb-4" style={{ color: s.color }}>
                  {s.step}
                </div>
      ...
      <section className="py-24 px-6" style={{ borderTop: '1px solid #1e2040' }}>
        <div className="max-w-4xl mx-auto">
          <div className="text-xs tracking-widest text-gray-500 text-center mb-4">
            THE WORKFORCE
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {AGENTS.map((a) => (
              ...
              >
                ...
                <div className="text-xs tracking-widest mb-1" style={{ color: a.color }}>
                  {a.name}
                </div>
                <div className="text-xs text-gray-500 mb-4">{a.role}</div>
                {a.capabilities.map((c) => (
                  <div key={c} className="flex items-start gap-2 mb-2">
                    <span className="text-xs mt-0.5 flex-shrink-0" style={{ color: a.color }}>
                      →
                    </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {TIERS.map((tier) => (
              ...
              >
                {tier.highlight && (
                  <div
                    className="text-xs tracking-widest mb-4 text-center px-3 py-1 rounded-full self-center"
                    style={{
                      color: tier.color,
                ...
                <div className="text-xs tracking-widest mb-2" style={{ color: tier.color }}>
                  {tier.name}
                </div>
                ...
                <div className="space-y-3 mb-8 flex-1">
                  {tier.features.map((f) => (
                    <div key={f} className="flex items-start gap-3">
                      <span className="text-xs mt-0.5 flex-shrink-0" style={{ color: tier.color }}>
                        ✓
                      </span>
      ...
      <section className="py-24 px-6" style={{ borderTop: '1px solid #1e2040' }}>
        <div className="max-w-2xl mx-auto text-center">
          <h2
            ...
            style={{ fontSize: 'clamp(32px, 6vw, 56px)', letterSpacing: '-1px' }}
          >
            Ready to run your business solo?
          </h2>
          <p className="text-gray-400 mb-10 text-sm leading-relaxed">
            Start your free trial today. No credit card. No setup fees.
            <br />
          ...
          {LAUNCH_MODE === 'live' ? (
            <Link
              href="/pricing"
              className="inline-block px-12 py-5 rounded-lg text-sm font-black tracking-widest"
              style={{ background: '#4fc3f7', color: '#080810' }}
            >
              START FOR FREE →
            </Link>
      ...
      <footer className="py-8 px-8" style={{ borderTop: '1px solid #1e2040' }}>
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="text-xs text-gray-600 tracking-widest">
            © 2026 WIREASSIST. ALL RIGHTS RESERVED.
          </div>
          <div className="flex gap-6">
            <Link
              href="/products"
              className="text-xs text-gray-600 hover:text-gray-400 tracking-widest"
            >
              PRODUCTS
            </Link>
            <Link
