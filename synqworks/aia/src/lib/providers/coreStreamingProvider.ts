 ...
 * Integrates @synqworks/core's native streaming with AIA app's provider interface
 * Provides direct streaming without Tauri IPC overhead
 */

import { ProviderFactory, handleStream } from '@synqworks/core';
...
export class CoreStreamingProvider implements Provider {
  ...
  private async streamResponse(
    ...
    try {
      ...
      // Handle stream with @synqworks/core's stream handler
