/**
 * Core Adapter Layer
 * Bridges @synqworks/core storage with the AIA app's database interface
...
/**
 * Adapter for @synqworks/core's ConversationStore to match the database API interface
 */
...
/**
 * Adapter for @synqworks/core's MessageStore to match the database API interface
 */
