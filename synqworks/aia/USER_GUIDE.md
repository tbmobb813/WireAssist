# AI Assist - User Guide

Welcome to the AI Assist! This comprehensive guide will help you get
...
The AI Assist is available in multiple formats:
...
2. **CLI Tool**: Use `ai-assist capture "command"` from terminal
...
cd ai-assist/cli && cargo build --release

# Capture command output with AI analysis
ai-assist capture "npm run build"
ai-assist capture "python test.py" --analyze
```
...
**A:** Yes! The `aia` CLI companion tool is included. See [CLI Documentation](CLI_GUIDE.md) for details.
