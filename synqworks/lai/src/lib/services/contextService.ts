 ...
 * Integrates with @synqworks/core's ContextBuilder
 */

import { ContextBuilder } from '@synqworks/core';
import type { AIContext, FileChange, FileContext } from '@synqworks/core';
