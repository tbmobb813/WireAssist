/**
 * @synqworks/core Provider Integration Tests
 * Verifies that @synqworks/core providers work correctly with LAI app's provider system
 */

import { describe, it, expect } from 'vitest';
import { ProviderFactory } from '@synqworks/core';
import type {
  ProviderCompletionOptions,
  ProviderResponse,
} from '@synqworks/core';

describe('@synqworks/core Provider Integration', () => {
