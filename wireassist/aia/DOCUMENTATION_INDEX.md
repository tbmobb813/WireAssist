# AI Assist - Complete Documentation Index

Welcome to the AI Assist documentation! This comprehensive resource
...
# For AppImage
chmod +x ai-assist*.AppImage
./ai-assist*.AppImage

# For Debian/Ubuntu
sudo apt install ./ai-assist*.deb
...
That's it! You're ready to use the AI Assist.
...
- Use `aia` commands in your terminal
- Use `aia capture` for safe command execution with AI analysis
...
Want to help improve the AI Assist?
...
AI Assist is licensed under [LICENSE FILE]. See repository for details.
