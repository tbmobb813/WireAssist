...
export const MODEL_CAPABILITIES: ModelCapability[] = [
  {
    ...
    strengths: ['reasoning', 'systems', 'rust', 'complex_logic', 'architecture'],
    costTier: 'high',
  ...
  },
  {
    ...
    bestFor: ['code_generation', 'data_analysis', 'creative_writing', 'documentation'],
...
export const QUERY_TYPE_PATTERNS: Record<QueryType, string[]> = {
  ...
  general_question: ['what', 'how', 'why', 'when', 'where', 'who', 'can you', '?'],
  documentation: [
    'document',
    'readme',
    'comments',
