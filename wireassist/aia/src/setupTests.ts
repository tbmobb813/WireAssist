...
if (typeof window !== 'undefined' && !window.matchMedia) {
  ...
  window.matchMedia = (query: string) => {
    const mql: MediaQueryList = {
      ...
      dispatchEvent: () => false,
      // legacy
      addListener: function (_listener: (this: MediaQueryList, ev: MediaQueryListEvent) => any) {
        // no-op
      },
      removeListener: function (_listener: (this: MediaQueryList, ev: MediaQueryListEvent) => any) {
        // no-op
      },
