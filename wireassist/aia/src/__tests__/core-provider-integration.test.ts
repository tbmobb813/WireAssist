/**
 * @wireassist/core Provider Integration Tests
 * Verifies that @wireassist/core providers work correctly with AIA app's provider system
 */

import { describe, it, expect } from 'vitest';
import { ProviderFactory } from '@wireassist/core';
import type { ProviderCompletionOptions, ProviderResponse } from '@wireassist/core';

describe('@wireassist/core Provider Integration', () => {
