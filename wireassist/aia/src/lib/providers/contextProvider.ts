...
export class ContextAwareProvider implements Provider {
  ...
  async generateResponse(
    ...
    return this.wrappedProvider.generateResponse(conversationId, messagesWithContext, onChunk);
  }

  /**
   * Inject context into messages as a system message
   */
  private injectContext(messages: ProviderMessage[], context: AIContext | null): ProviderMessage[] {
