 ...
 * Integrates with @wireassist/core's ContextBuilder
 */

import { ContextBuilder } from '@wireassist/core';
import type { AIContext, FileChange, FileContext } from '@wireassist/core';
