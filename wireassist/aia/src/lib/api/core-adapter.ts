/**
 * Core Adapter Layer
 * Bridges @wireassist/core storage with the AIA app's database interface
...
import type { ApiConversation, ApiMessage, NewConversation, NewMessage } from './types';

/**
 * Adapter for @wireassist/core's ConversationStore to match the database API interface
 */
...
/**
 * Adapter for @wireassist/core's MessageStore to match the database API interface
 */
