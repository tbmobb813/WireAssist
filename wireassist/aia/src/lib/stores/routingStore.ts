...
import { RoutingSettings, RoutingDecision, DEFAULT_ROUTING_SETTINGS } from '../../types/routing';
...
interface RoutingStore {
  ...
  addRoutingDecision: (decision: RoutingDecision, queryType: string, projectType?: string) => void;
