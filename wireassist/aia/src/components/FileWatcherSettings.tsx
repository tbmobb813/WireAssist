...
import { X, Eye, EyeOff, Plus, Trash2, AlertCircle, Check, Info } from 'lucide-react';
...
export default function FileWatcherSettings({ onClose }: FileWatcherSettingsProps) {
    ...
    <div className="w-[700px] max-h-[80vh] overflow-y-auto bg-[#1a1b26] border border-[#414868] rounded-lg shadow-2xl">
      ...
      <div className="flex items-center justify-between p-4 border-b border-[#414868]">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-semibold text-[#c0caf5]">File Watcher Settings</h2>
        </div>
        {onClose && (
          <button
            onClick={onClose}
      ...
      <div className="p-4">
        ...
        <div className="mb-6 p-3 bg-[#7aa2f7]/10 border border-[#7aa2f7]/30 rounded-lg">
          <div className="flex items-start gap-2">
            ...
            <div className="text-sm text-[#c0caf5]">
              <strong>File Watcher:</strong> Monitor specific files in your project for changes. Use
              glob patterns like **/*.js or src/**/*.tsx to watch multiple files.
            </div>
          </div>
        </div>
        ...
        {/* Add Pattern */}
        <div className="mb-6">
          <label className="block text-sm font-medium text-[#c0caf5] mb-2">Add Watch Pattern</label>
          ...
          <div className="space-y-2">
            {patterns.length === 0 ? (
              <div className="text-center py-8 text-[#9aa5ce]">
                ...
                <p className="text-sm mt-1">Add a pattern above to start watching files</p>
              </div>
            ) : (
              patterns.map((pattern) => (
                ...
                >
                  <div className="flex items-center gap-3 flex-1">
                    ...
                    <code className="text-sm font-mono text-[#c0caf5]">{pattern.pattern}</code>
                  </div>
                  <button
        ...
        <div className="mt-6 pt-4 border-t border-[#414868]">
          <div className="text-xs text-[#9aa5ce]">
            ...
            <ul className="mt-2 space-y-1 list-disc list-inside">
              ...
              <li>
                <code>{'src/**/*.{js,jsx}'}</code> - JS/JSX files in src directory
              </li>
              <li>
