    ...
    >
      ...
      {!searchQuery && (
        <div className="text-xs text-[#565f89] mb-3 flex items-center gap-2">
          <kbd className="px-1.5 py-0.5 bg-[#24283b] border border-[#414868] rounded">⌘F</kbd>
          <span>to search</span>
          <span>•</span>
          <kbd className="px-1.5 py-0.5 bg-[#24283b] border border-[#414868] rounded">N</kbd>
          <span>next</span>
          <span>•</span>
          <kbd className="px-1.5 py-0.5 bg-[#24283b] border border-[#414868] rounded">Esc</kbd>
          <span>close</span>
        </div>
      )}
      ...
      {searchQuery && (
        <div className="space-y-2">
          {matchingMessages.length === 0 ? (
            <div className="text-sm text-[#565f89] text-center py-4">No messages found</div>
          ) : (
            <div className="max-h-60 overflow-y-auto smooth-scroll space-y-2 pr-1">
              {matchingMessages.map((message) => (
                <button
                  ...
                  className={`w-full text-left p-3 rounded-lg text-sm transition-all duration-150 gpu-accelerated ${
