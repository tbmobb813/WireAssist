        ...
        <div className="flex items-center gap-2">
          <div
            className={`w-3 h-3 rounded-full ${
              checkingConnection ? 'bg-yellow-500' : connected ? 'bg-green-500' : 'bg-red-500'
            }`}
          />
        ...
        <>
          ...
          {models.length > 0 && (
            <div className="text-xs text-gray-600 dark:text-gray-400 bg-blue-50 dark:bg-blue-900/20 p-2 rounded">
              💡 Copy a model name and paste it into the "Default model" field in Settings to use it
              as your default Ollama model.
            </div>
          )}
        </>
      )}
