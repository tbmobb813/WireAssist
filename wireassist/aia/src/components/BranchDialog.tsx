...
export default function BranchDialog({ messageId, onClose, onBranchCreated }: BranchDialogProps) {
  ...
  return (
    ...
    >
      <div className="bg-[#1a1b26] border border-[#414868] rounded-lg shadow-2xl p-6 w-full max-w-md mx-4">
        <h2 className="text-lg font-semibold mb-4 text-[#c0caf5]">Create Branch</h2>
        <p className="text-sm text-[#9aa5ce] mb-4">
          Create a new conversation branch from this message point. This allows you to explore
          alternative conversation paths.
        </p>

        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="branch-title" className="block text-sm font-medium text-[#9aa5ce] mb-2">
              Branch Title
            </label>
            <input
              id="branch-title"
