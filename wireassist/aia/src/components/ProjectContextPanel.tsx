...
export default function ProjectContextPanel({ onClose }: ProjectContextPanelProps) {
    ...
    <div className="fixed right-4 top-16 w-80 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-40 max-h-96 overflow-hidden">
      ...
      <div className="p-3 border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center gap-1 text-xs">
          ...
          <span className="text-gray-500 dark:text-gray-400">Show changes from:</span>
        </div>
            ...
            {recentEvents.map((event, index) => (
              ...
              >
                <div className="flex items-start gap-2">
                  <span className="text-sm mt-0.5">{getFileIcon(event.path)}</span>
