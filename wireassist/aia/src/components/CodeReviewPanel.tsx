            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  {currentSession ? currentSession.title : 'Select or create a review session'}
                </p>
              </div>
            </div>
            <button
              ...
              {currentSession ? (
                ...
                <div className="flex items-center justify-center h-full text-gray-500 dark:text-gray-400">
                  <div className="text-center">
                    ...
                    <p className="text-lg font-semibold mb-2">Select a Review Session</p>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                        Tip: Run{' '}
                        <code className="px-1 bg-gray-100 dark:bg-gray-700 rounded">git diff</code>{' '}
