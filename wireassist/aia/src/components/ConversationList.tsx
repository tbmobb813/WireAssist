...
import { AnimatedButton, StaggerContainer, FadeIn, Skeleton } from './Animations';
    ...
    >
      ...
      <div className="p-4 border-b border-[#414868]">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold text-[#c0caf5]">Conversations</h2>
          <AnimatedButton
            onClick={async () => {
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-2">
        {isLoading && (
          <div className="space-y-3">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="px-4 py-3 rounded-xl space-y-2 bg-[#24283b]/30">
