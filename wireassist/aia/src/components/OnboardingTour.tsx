...
import { useOnboardingStore, type OnboardingStep } from '../lib/stores/onboardingStore';
import {
  Terminal,
  Sparkles,
  FileCode,
...
const STEP_CONTENT: Record<OnboardingStep, StepContent | null> = {
  ...
  terminal: {
    ...
    description:
      'Pipe errors, logs, and command output directly to the AI using the `aia` CLI tool.',
    icon: <Terminal className="text-[#9ece6a]" size={32} />,
    benefits: [
      'Analyze errors: cargo build 2>&1 | aia analyze',
      "Get suggestions: aia capture 'npm test'",
      'Open GUI: aia --gui',
    ],
  ...
  settings: {
    ...
    description: 'Customize everything: API keys, models, shortcuts, routing behavior, and more.',
...
export default function OnboardingTour() {
  const { showTour, currentStep, nextStep, prevStep, skipTour, hasCompletedOnboarding } =
    useOnboardingStore();
          ...
          <div className="relative bg-gradient-to-r from-[#24283b] to-[#1a1b26] px-8 py-6 border-b border-[#414868]/50">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <h2 className="text-2xl font-bold text-[#c0caf5] mb-1">{stepContent.title}</h2>
          ...
          <div className="px-8 py-6 space-y-6">
            ...
            <div>
              <h3 className="text-sm font-semibold text-[#c0caf5] uppercase tracking-wide mb-3">
                {currentStep === 'welcome' ? "What you'll learn:" : 'Key Features:'}
              </h3>
            ...
            {stepContent.tip && (
              <div className="bg-[#7aa2f7]/10 border border-[#7aa2f7]/30 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-[#7aa2f7] mb-1">Pro Tip</p>
