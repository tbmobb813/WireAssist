...
import { FileText, Activity, Keyboard, Monitor, Search, User, BarChart3 } from 'lucide-react';
...
export default function Settings({ onClose }: Props): JSX.Element {
  const { globalShortcut, setGlobalShortcut, theme, setTheme } = useSettingsStore();
  ...
  return (
    <div className="w-96 bg-white dark:bg-gray-900 border border-gray-200/70 dark:border-gray-700/60 rounded-xl shadow-2xl shadow-gray-500/10 dark:shadow-black/20 text-gray-900 dark:text-white overflow-hidden">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400">Configure your preferences</p>
            </div>
          </div>
          {onClose && (
            <button
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <span className="text-xs font-medium text-center">File Watcher</span>
            </button>
            ...
            >
              ...
              <span className="text-xs font-medium text-center">Performance</span>
            </button>
          </div>
            ...
            <Suspense
              fallback={
                <div className="w-96 bg-[#1a1b26] border border-[#414868] rounded-xl shadow-2xl p-6">
                  <div className="flex items-center justify-center">
                    <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#7aa2f7]"></div>
                    <span className="ml-2 text-[#9aa5ce]">Loading window settings...</span>
                  </div>
                </div>
              }
            >
            ...
            <Suspense
              fallback={
                <div className="w-96 bg-[#1a1b26] border border-[#414868] rounded-xl shadow-2xl p-6">
                  <div className="flex items-center justify-center">
                    <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#7aa2f7]"></div>
                    <span className="ml-2 text-[#9aa5ce]">Loading file watcher...</span>
                  </div>
                </div>
              }
            >
            ...
            <Suspense
              fallback={
                <div className="w-96 bg-[#1a1b26] border border-[#414868] rounded-xl shadow-2xl p-6">
                  <div className="flex items-center justify-center">
                    <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#7aa2f7]"></div>
                    <span className="ml-2 text-[#9aa5ce]">Loading performance dashboard...</span>
                  </div>
                </div>
              }
            >
            ...
            <Suspense
              fallback={
                <div className="w-96 bg-[#1a1b26] border border-[#414868] rounded-xl shadow-2xl p-6">
                  <div className="flex items-center justify-center">
                    <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#7aa2f7]"></div>
                    <span className="ml-2 text-[#9aa5ce]">Loading document search...</span>
                  </div>
                </div>
              }
            >
      ...
      {showLicensePanel && <LicensePanel onClose={() => setShowLicensePanel(false)} />}
    </div>
  );
}
        ...
        <div className="bg-gradient-to-r from-amber-50 to-yellow-50 dark:from-gray-800/50 dark:to-gray-700/50 px-6 py-4 border-b border-gray-200/50 dark:border-gray-700/50 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400">
                Manage your keys and subscription
              </p>
            </div>
          </div>
          <button
        ...
        <div className="p-6 space-y-5 max-h-[70vh] overflow-y-auto">
          ...
          <div className="bg-gray-50/50 dark:bg-gray-800/30 rounded-lg p-4 border border-gray-200/50 dark:border-gray-700/50">
            ...
            {licenseStatus ? (
              <div className="flex items-center justify-between">
                <span
                  className={`text-lg font-bold ${tierColor[licenseStatus.tier] ?? tierColor.trial}`}
                >
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400">
              Enter your WireAssist license key to unlock Solo, Operator, or Workforce features.
            </p>
            <div className="flex space-x-2">
              <input
                type="text"
