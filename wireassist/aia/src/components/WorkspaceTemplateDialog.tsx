...
export const WorkspaceTemplateDialog: React.FC<WorkspaceTemplateDialogProps> = ({
  isOpen,
  onClose,
  onSave,
  template,
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                >
                  {(models[formData.default_provider as keyof typeof models] || []).map((model) => (
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, file_extensions: e.target.value })}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, ignore_patterns: e.target.value })}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
        ...
        <div className="flex items-center justify-end space-x-3 p-6 border-t border-gray-200 dark:border-gray-700">
          ...
          >
            ...
            <span>{loading ? 'Saving...' : template ? 'Update' : 'Create'}</span>
          </button>
        </div>
      </div>
    </div>
