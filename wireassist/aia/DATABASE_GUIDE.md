...
This guide will walk you through setting up the complete database layer for your AI Assist, including both backend (Rust) and frontend (TypeScript) integration.

## Prerequisites

✅ You've run the initial setup script  
✅ You have VS Code installed (optional but recommended)  
✅ Your project is at `ai-assist/`
      ...
      <main className="flex-1 flex flex-col">
        <header className="p-4 border-b border-gray-700">
          <h1 className="text-xl font-bold">
            {currentConversation?.title || "AI Assist"}
          </h1>
...
```bash
# On Linux
~/.local/share/com.aiassist.app/database.db
```
...
sqlite3 ~/.local/share/com.aiassist.app/database.db
